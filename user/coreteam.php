		...
		<div class="container-fluid">
          ...
          <nav class="cl-effect-1" id="cl-effect-1">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="coreteam.php">Core Team</a></li>
...
<div class="container" style="margin-top: 2%; height: 900px">
<div class="panel panel-primary">
      <div class="panel-heading" style="text-align: center;"> <h1 class="m_3">OUR CORE TEAM</h1></div>
      <div class="panel-body">
       ...
       <img src="../Images/SwethaMallidi.jpg" class="img-responsivesmall" alt="">
        <div class="overlay">
            <h2>Mrs. Swetha Mallidi</h2>
            <!-- <a class="info" href="SwethaMallidi.html">View Details</a> -->
        </div>
<h2>Swetha Mallidi</h2>
    </div>
           <h4  class="m_4"></h1>     
            </div>
            <div class="col-md-4 top_box">
                <div class="hovereffect">
       <img src="../Images/SUSHAP.jpg" class="img-responsivesmall" alt="">
        <div class="overlay">
            <h2>Dr. Susheela Murthy</h2>
            <!-- <a class="info" href="SusheelaMurthy.html">View Details</a> -->
        </div>
<h2>Susheela Murthy</h2>
    </div>
                <h4 class="m_4"></h4>
            </div>
            ...
            <div class="col-md-4 top_box">
               <div class="hovereffect">
       <img src="../Images/farzanaBegum.jpg" class="img-responsivesmall" alt="">
        <div class="overlay">
            <h2>Mrs Farzana Begum</h2>
            <!-- <a class="info" href="FarzanaBegum.html">View Details</a> -->
        </div>
<h2>Farzana Begum</h2>
    </div>
                <h4 class="m_4"></h4>
 ...
 <div class="row top-buffer">
            <div class="col-md-4 top_box">
                <div class="hovereffect">
       <img src="../Images/Ravi.jpg" class="img-responsivesmall" alt="">
        <div class="overlay">
            <h2>Ravi</h2>
        ...
        <h2>Ravi</h2>
            ...
            <div class="col-md-4 top_box">
                <div class="hovereffect">
       <img src="../Images/Amit.jpg" class="img-responsivesmall" alt="">
        <div class="overlay">
            <h2>Amit</h2>
            <!-- <a class="info" href="#">View Details</a> -->
        </div>
