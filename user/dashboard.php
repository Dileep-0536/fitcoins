            ...
            <div class="container-fluid">
                <nav class="navbar navbar-default">
                    ...
                    <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                        <nav class="cl-effect-1" id="cl-effect-1" style="float:right; ">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-3 top_box">
                        <div class="hovereffect">
                            <img src="../Images/aerobics.jpg" class="img-responsivesmall" alt="">
                            <div class="overlay">
                                <h2>Aerobics</h2>
                                <a class="info" href="leaderboard.php?activity_id=3">View Details</a>
                            </div>
                    ...
                    <div class="col-md-3 top_box">
                        <div class="hovereffect">
                            <img src="../Images/cycling.jpg" class="img-responsivesmall" alt="">
                            <div class="overlay">
                                <h2>Cycling</h2>
                                <a class="info" href="leaderboard.php?activity_id=2">View Details</a>
                            </div>
                        </div>
                        <h4 class="m_4"></h4>
                    </div>
                    ...
                    <div class="col-md-3 top_box">
                        <div class="hovereffect">
                            <img src="../Images/dancing.jpg" class="img-responsivesmall" alt="">
                            <div class="overlay">
                                <h2>Dancing</h2>
                                <a class="info" href="leaderboard.php?activity_id=4">View Details</a>
                            </div>
                        </div>
                        <h4 class="m_4"></h4>
                    </div>
                    ...
                    <div class="col-md-3 top_box">
                        <div class="hovereffect">
                            <img src="../Images/running.jpg" class="img-responsivesmall" alt="">
                            <div class="overlay">
                                <h2>Running</h2>
                                <a class="info" href="leaderboard.php?activity_id=1">View Details</a>
                            </div>
                        </div>
                        <h4 class="m_4"></h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 top_box">
                        <div class="hovereffect">
                            <img src="../Images/walking.jpg" class="img-responsivesmall" alt="">
                            <div class="overlay">
                                <h2>Walking</h2>
                                <a class="info" href="leaderboard.php?activity_id=6">View Details</a>
                            </div>
                        </div>
                        <h4 class="m_4"></h4>
                    </div>
                    ...
                    <div class="col-md-3 top_box">
                        <div class="hovereffect">
                            <img src="../Images/swimming.jpg" class="img-responsivesmall" alt="">
                            <div class="overlay">
                                <h2>Swimming</h2>
                                <a class="info" href="leaderboard.php?activity_id=5">View Details</a>
                            </div>
                        </div>
                        <h4 class="m_4"></h4>
                    </div>
                    ...
                    <div class="col-md-3 top_box">
                        <div class="hovereffect">
                            <img src="../Images/yoga.png" class="img-responsivesmall" alt="">
                            <div class="overlay">
                                <h2>Yoga</h2>
                                <a class="info" href="leaderboard.php?activity_id=7">View Details</a>
                            </div>
                        </div>
                        <h4 class="m_4"></h4>
                    </div>
                    ...
                    <div class="col-md-3 top_box">
                        <div class="hovereffect">
                            <img src="../Images/gym.jpg" class="img-responsivesmall" alt="">
                            <div class="overlay">
                                <h2>Gym</h2>
                                <a class="info" href="leaderboard.php?activity_id=8">View Details</a>
                            </div>
                        </div>
                        <h4 class="m_4"></h4>
                    </div>
