<?php 
    ...
    if (isset($_GET['id'])) {
        ...
        $activity_res = $result->fetch_assoc();
    ...
    <div class="container" style="margin-top: 2%; height: 600px">
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center;">
                <h3>Edit Activitiy</h3>
            </div>
            <div class="panel-body">
            	
            	<form action="activityeditaction.php" method="post">
                    <div class="form-group">
                        ...
                        <select class="form-control" required name="activity_id" id="activity_id">
                            ...
                            while($row = $res->fetch_assoc()){?>
                                <option value="<?= $row['activity_id'] ?>"<?php echo ($row['activity_id'] == $activity_res['activity_id']) ? "selected='selected'" : ""; ?>><?= $row['name'] ?></option>
                            <?php }
                            ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="time" class="form-control" required placeholder="Enter Time spent In Minutes" value="<?= $activity_res['time'] ?>">
                    </div>

                    <div class="form-group">
                        <label for="date">Date *</label>
                        <input type="text" name="date" class="form-control" required placeholder="Enter Time spent In Minutes" id="date" value="<?= $activity_res['date'] ?>">
                    </div>

                    <div class="form-group" id="distancediv">
                      <label for="distance">Total distance ( in KM )</label>
                      <input type="number" class="form-control" name="distance"  placeholder="Enter distance in meters" value="<?= $activity_res['distance'] ?>">
                    </div>

                   <div class="form-group" id="routediv">
                      <label for="route">Route</label>
                      <input type="text" class="form-control" name="route" id="route" placeholder="Enter Route" value="<?= $activity_res['route'] ?>">
                    </div>

                    <div class="form-group" id="citydiv">
                      <label for="city">City</label>
                      <input type="text" class="form-control" name="city" id="city" placeholder="Enter City" value="<?= $activity_res['city'] ?>">
                    </div>

                    <div class="form-group" style="text-align: center;">
                      <button type="submit" name="Submit" class="btn btn-primary waves" value="submit">EDIT ACTIVITY</button>
                    </div>
                </form>
            </div>
        </div>
