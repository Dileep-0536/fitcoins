			...
			<div class="" style="height: 500px">
				<div class="row text-white">
					<div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-4">
						<h1 style="padding-top: 3%;padding-bottom: 4%; color: #fff" class="display-4 py-2 text-truncate">LOGIN </h1>
						<div class="px-2">
							<span style="color:#ff0000;font-size: 15px;padding-bottom: 1%">
							<?php
							...
							<form style="color:#ff0000;font-size: 15px;padding-top: 5%" action="login_check.php" class="justify-content-center" method="post">
								<div class="form-group">
									<label class="sr-only">Email</label>
									<input type="mail" class="form-control" required placeholder="Enter Registered Email" name="email" id="email">
								</div>
								<div class="form-group">
									<label class="sr-only">Password</label>
									<input type="Password" class="form-control" required placeholder="Enter Password" name="password" id="password">
								</div>
