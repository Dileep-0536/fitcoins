...
<div class="px-2 beyond-info beyond-info_m">
<div class="well" style="text-align:center;padding-bottom: 10px;width: 86%;margin-left: 7%;margin-top: 2%;background-color: #06427b;color: white;"><span class="panal_title">Gallary</span></div>
<div class="container" style="height: 600px;z-index: 9999">
<div class="row">
  <div class="column">
    <img src="../images/ban1.jpg" style="width:100%" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="../images/ban2.jpg" style="width:100%" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="../images/ban3.jpg" style="width:100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="../images/ban4.jpg" style="width:100%" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
  </div>
</div>
<div class="row" style="padding-top: 2%">
  <div class="column">
    <img src="../images/ban5.jpg" style="width:100%" onclick="openModal();currentSlide(5)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="../images/ban6.jpg" style="width:100%" onclick="openModal();currentSlide(6)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="../images/ban7.jpg" style="width:100%" onclick="openModal();currentSlide(7)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="../images/ban8.jpg" style="width:100%" onclick="openModal();currentSlide(8)" class="hover-shadow cursor">
  </div>
</div>
</div>
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="mySlides">
      ...
      <img src="../images/ban6.jpg" style="width:100%">
    </div>

    <div class="mySlides">
      <div class="numbertext">7 / 8</div>
      <img src="../images/ban7.jpg" style="width:100%">
    </div>
    
    <div class="mySlides">
      <div class="numbertext">8 / 8</div>
      <img src="../images/ban8.jpg" style="width:100%">
    </div>
