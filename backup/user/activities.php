<?php 
	...
	// fetch the data for his activities
	$key = 0;
	$activities_array = array();     // array for getting the data of the activities
	$user_id = $_SESSION['id'];
	$query = "SELECT * FROM `user_activities` join `activities` on user_activities.activity_id = activities.activity_id WHERE user_activities.user_id = '".$user_id."' ORDER BY user_activities.date DESC ";
	$result = $conn->query($query);
	while($row = $result->fetch_assoc()) {
		$activities_array[$key]['name'] = $row['name'];
            ...
            <div class="panel-body">
            	<div class="row" style="margin: 10px 0px;">
            		<button class="btn btn-primary pull-right">
            			<a href="add_activity.php" style="color: white;text-decoration: none;">
            				+ Add Activity
            			</a>
            		</button>
            	</div>
            	<div class="row">
            		<table class="table table-bordered table-striped table-hover" id="activities_table">
            			<thead>
            				<tr>
	            				<th style="100px!important;">Activity</th>
	            				<th style="100px!important;">Time Spent (in mins)</th>
	            				<th style="100px!important;">Date of Activity</th>
	            				<th style="100px!important;">Distance (in KM)</th>
                                <th style="100px!important;">City</th>
	            				<th style="100px!important;">Route</th>
            				</tr>
            			</thead>
            			<tbody>
            				<?php
