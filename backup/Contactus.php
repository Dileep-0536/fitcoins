...
<div class="">
           ...
           <div class=" col-md-5 contact-form">
				...
				<ul class="con_inner_text">
					<b style="color: #fff;font-size: 22px;padding-left: 3%">Fitness Icons  </b><span style="font-family: 'Hind Vadodara', sans-serif;color: #fff;font-size: 18px;"><i>- Become an Inspiration</i></span><br>
							<li>
...
<li><span class="fa fa-envelope-o" aria-hidden="true"></span> 
	<a href="mailto:shivomintel@gmail.com">info@gfitcons.in</a></li>
						</ul>
			</div>
