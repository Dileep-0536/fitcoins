		...
		<div class="container-fluid">
          ...
          <nav class="cl-effect-1" id="cl-effect-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="upcoming_events.php">Upcoming Events</a></li>
...
<div class="panel panel-primary">
      <div class="panel-heading" style="text-align: center;"> <h1 class="m_3">UPCOMING EVENTS</h1></div>
...
<div class="px-2 beyond-info beyond-info_m" style="text-align: center;">

                      <h1>  We are working to make this site more interesting for you !!
<br>Meanwhile you keep up with your activities and stay tuned.</h1>
                    </div>
