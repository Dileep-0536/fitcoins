...
<div class="panel panel-primary">
      <div class="panel-heading" style="text-align: center;"> <h1 class="m_3">CONTACT US </h1></div>
...
<div class="">
           ...
           <div class=" col-md-5 contact-form">
				...
				<ul class="con_inner_text">
					<b style="color: #fff;font-size: 22px;padding-left: 3%">Tarblazers  </b><span style="font-family: 'Hind Vadodara', sans-serif;color: #fff;font-size: 18px;"><i>- Become an Inspiration</i></span><br>
							<li>
								<p><span class="fa fa-map-marker" aria-hidden="true"></span>#38-30-123 / 106 Flat ,</p>
								<p style="padding-left:6% "> G N Mansion, Marripalem,</p> 
                             
								<p style="padding-left:6% ">Visakhapatnam – 530018,  </p>
							    <p style="padding-left:6% ">Andhra Pradesh , INDIA.</p></li>
...
<li><span class="fa fa-phone" aria-hidden="true"></span> +91 96183 27073 </li>
<li><span class="fa fa-envelope-o" aria-hidden="true"></span> 
	<a href="mailto:shivomintel@gmail.com">info@gtarblazers.com</a></li>
						</ul>
			</div>
           <div class="col-md-6 map-md-6 map contact-form">
